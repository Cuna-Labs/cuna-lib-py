...
The accepted error types are `RunaError`, `ConfigError`, `ApiError`, and `CommandError` from
`runa.errors`; local lookup outcomes and native async cancellation remain native. Keep the
