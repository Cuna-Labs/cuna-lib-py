...
def verify_local() -> dict[str, object]:
    commands = {
        "format": [sys.executable, "-m", "uv", "run", "ruff", "format", "--check", "."],
        "lint": [sys.executable, "-m", "uv", "run", "ruff", "check", "."],
        "mypy": [sys.executable, "-m", "uv", "run", "mypy", "src", "tests/typing/consumer.py"],
        "pyright": [
            sys.executable,
            "-m",
            "uv",
        ...
        "dependencyAudit": [sys.executable, "-m", "uv", "run", "pip-audit"],
        "dependencyPolicy": [
            sys.executable,
            "-m",
            "uv",
